    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            ...
            <div class="bg-white rounded p-4 shadow-sm mb-3 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold text-dark">Tambah Mutasi Penambahan</h5>
                    ...
                    <form wire:submit="store">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                @error('saldo_awal') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Belanja</label>
                                <input type="number" class="form-control @error('belanja') is-invalid @enderror" 
                                       wire:model="belanja">
                                @error('belanja') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
