        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="card shadow-sm mb-5">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">Edit Data Persediaan</h5>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit="update">
                        ...
                        <div class="mb-3">
                            ...
                            @error('kategori_persediaan') <span class="text-danger small">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" wire:model="saldo">
                        </div>

                        <hr>

                        <details class="mb-3 border rounded shadow-sm">
                            <summary class="p-3 bg-light fw-bold" style="cursor: pointer;">➕ Penambahan</summary>
                            <div class="p-3">
                                <div class="mb-3">
                        ...
                        <details class="mb-3 border rounded shadow-sm">
                            <summary class="p-3 bg-light fw-bold" style="cursor: pointer;">➖ Pengurangan</summary>
                            <div class="p-3">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control"
                                        wire:model="reklasifikasi_pengurangan">
                                </div>
                            </div>
                        </details>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('MutasiPersediaan.index') }}" class="btn btn-secondary" wire:navigate>
                                Batal
                            </a>
                        </div>
                    </form>
