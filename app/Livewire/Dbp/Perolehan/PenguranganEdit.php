...
class PenguranganEdit extends Component
{
    ...
    {
        $data = PerolehanPengurangan::findOrFail($id);
    ...
    public function update()
    {
        ...
        $data = PerolehanPengurangan::find($this->id_data);
        ...
        session()->flash('success', 'Data Perolehan Pengurangan berhasil diperbarui.');
    ...
    {
        return view('livewire.dbp.perolehan.pengurangan-edit');
    }
}